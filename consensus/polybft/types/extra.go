...
func (i *Extra) ValidateFinalizedData(header *types.Header, parent *types.Header, parents []*types.Header,
	chainID uint64, consensusBackend Polybft, domain []byte, logger hclog.Logger) error {
...
func (i *Extra) ValidateParentSignatures(blockNumber uint64, consensusBackend Polybft, parents []*types.Header,
