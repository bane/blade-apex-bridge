...
// PostBlock provides a mock function with given fields:
func (_m *BridgeManagerMock) PostBlock() error {
	ret := _m.Called()
...
func (_e *BridgeManagerMock_Expecter) PostBlock() *BridgeManagerMock_PostBlock_Call {
	return &BridgeManagerMock_PostBlock_Call{Call: _e.mock.On("PostBlock")}
}

func (_c *BridgeManagerMock_PostBlock_Call) Run(run func()) *BridgeManagerMock_PostBlock_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *BridgeManagerMock_PostBlock_Call) RunAndReturn(run func() error) *BridgeManagerMock_PostBlock_Call {
	_c.Call.Return(run)
	return _c
}
