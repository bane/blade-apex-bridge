...
func FuzzTestStakeManagerPostBlock(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, input []byte) {
		...
		require.NoError(t, state.insertFullValidatorSet(validator.ValidatorSetState{
...
func FuzzTestStakeManagerUpdateValidatorSet(f *testing.F) {
	...
	err := state.insertFullValidatorSet(validator.ValidatorSetState{
		Validators: validator.NewValidatorStakeMap(validators.GetPublicIdentities())}, nil)
