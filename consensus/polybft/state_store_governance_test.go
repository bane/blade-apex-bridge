...
func createTestPolybftConfig() *PolyBFTConfig {
	return &PolyBFTConfig{
		...
		Bridge: map[uint64]*BridgeConfig{0: {
			...
			ChildERC721PredicateAddr:  types.StringToAddress("0xChildMintableERC721PredicateAddr"),
			RootERC1155PredicateAddr:  types.StringToAddress("0xRootERC1155PredicateAddr"),
			ChildERC1155PredicateAddr: types.StringToAddress("0xChildMintableERC1155PredicateAddr"),
